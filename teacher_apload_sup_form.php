...
<head>
    <meta charset="UTF-8">
    <title>H.O.D SUP Results Entry</title>
...
<h4>Upload SUP Results</h4>
    <!-- Include the Sidebar -->
    <?php include 'sidebar_teacher.php'; ?>

    <form id="filterForm" method="POST" action="teacher_apload_sup.php">
        ...
        <button type="submit">Upload SUP Results</button>
    </form>
</div>
