                        ...
                        <tbody>
                            <?php foreach ($result_rows as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_result.php?id=<?php echo $row['id']; ?>&type=ue">Edit</a> |
                                        <a href="delete_result.php?id=<?php echo $row['id']; ?>&type=ue" onclick="return confirm('Are you sure?')">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
